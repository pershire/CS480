...
public class HTMLParser {
	...
	public static void main(String[] args) {
		...
		ArrayList<String> interestNumArray = new ArrayList<String>();
		...
		System.out.println("Want to find where the events are? Well, let us help you...");
		System.out.print("First, Enter Your City: ");
		usercity =userinput.nextLine().trim();
		System.out.print("Second, Enter Your State (Ex: CA): ");
		userstate =userinput.nextLine().trim();
		
		System.out.print("Third, Enter Which Date (Note: format in mm-dd-yyyy): ");
		userdate = userinput.nextLine().trim();
